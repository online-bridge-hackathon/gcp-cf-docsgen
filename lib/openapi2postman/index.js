...
const XAPIKEY = process.env.POSTMAN_APIKEY || 'PMAK-5f20206b25623a0037a1e818-c81efbc09db6aa4e402582f7be985c80c6'
...
module.exports = spec => convert({ type: 'string', data: JSON.stringify(spec) }, {})
  ...
  .then(() => console.log('Sucessfully updated POSTMAN collection'))
